package com.jzhangs.coolweather.service;
...
import com.jzhangs.coolweather.receiver.AutoUpdateReceiver;
...
public class AutoUpdateService extends Service {
    ...
    private void updateWeather() {
        ...
        String address = Utility.CITYID_URL + cityId + Utility.API_KEY;
